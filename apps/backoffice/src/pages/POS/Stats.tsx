    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6 bg-gradient-card border-0 shadow-md lg:col-span-2">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={sellerPerformance} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="name" />
              <YAxis />
              <Tooltip />
      ...
      <Card className="p-6 bg-gradient-card border-0 shadow-md">
        ...
        <div className="space-y-3">
          {[
            { time: "2 minutes ago", seller: "Jane Smith", amount: "$45.99", items: "Pizza, Coke" },
            { time: "5 minutes ago", seller: "John Doe", amount: "$699.99", items: "Smartphone" },
            { time: "8 minutes ago", seller: "Sarah Wilson", amount: "$23.97", items: "Coffee, Burger" },
            { time: "12 minutes ago", seller: "Mike Johnson", amount: "$129.99", items: "Wireless Headphones" },
