...
import { Upload, Palette, Type, Move, Settings } from 'lucide-react';
...
const ControlPanel = ({ bannerData, updateBannerData }: ControlPanelProps) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 h-fit">
      <h2 className="text-2xl font-semibold text-slate-800 mb-6">Customize Banner</h2>
        ...
        <TabsContent value="content" className="space-y-4 mt-6">
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={([value]) => updateBannerData({ titleSize: value })}
              max={72}
              min={12}
              step={2}
              className="mt-2"
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={([value]) => updateBannerData({ subtitleSize: value })}
              max={48}
              min={10}
              step={2}
              className="mt-2"
        ...
        <TabsContent value="style" className="space-y-4 mt-6">
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => updateBannerData({ subtitleColor: e.target.value })}
              className="mt-1 h-10"
            />
          </div>
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) => updateBannerData({ titleFont: value, subtitleFont: value })}
            >
        ...
        <TabsContent value="layout" className="space-y-4 mt-6">
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={([value]) => updateBannerData({ 
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={([value]) => updateBannerData({ 
                subtitlePosition: { ...bannerData.subtitlePosition, x: value }
              })}
              max={100}
              min={0}
              step={5}
          ...
          <div>
            ...
            <Slider
              ...
              onValueChange={([value]) => updateBannerData({ 
                subtitlePosition: { ...bannerData.subtitlePosition, y: value }
              })}
              max={100}
              min={0}
              step={5}
