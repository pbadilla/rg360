...
import { Users, Search, Plus, Edit, Star, DollarSign, ShoppingCart } from "lucide-react";
...
const Sellers = () => {
  ...
  const averageRating = sellers.reduce((sum, s) => sum + s.rating, 0) / sellers.length;
      ...
      <Card className="p-6 bg-gradient-card border-0 shadow-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredSellers.map((seller) => (
            <Card key={seller.id} className="p-6 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-3 mb-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-medium">${seller.sales.toLocaleString()}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm">{new Date(seller.joinDate).toLocaleDateString()}</span>
                </div>
              </div>
